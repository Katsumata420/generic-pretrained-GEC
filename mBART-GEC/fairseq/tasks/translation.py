...
def load_langpair_dataset(
    ...
    eos = None
    if append_source_id and gec_lang is None:
        src_dataset = AppendTokenDataset(src_dataset, src_dict.index('[{}]'.format(src)))
        if tgt_dataset is not None:
            tgt_dataset = AppendTokenDataset(tgt_dataset, tgt_dict.index('[{}]'.format(tgt)))
        eos = tgt_dict.index('[{}]'.format(tgt))
    elif append_source_id and gec_lang is not None:
        src_dataset = AppendTokenDataset(src_dataset, src_dict.index('[{}]'.format(gec_lang)))
        if tgt_dataset is not None:
            tgt_dataset = AppendTokenDataset(tgt_dataset, tgt_dict.index('[{}]'.format(gec_lang)))
        eos = tgt_dict.index('[{}]'.format(gec_lang))
